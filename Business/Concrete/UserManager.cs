...
namespace Business.Concrete
{
    ...
    //[SecuredOperation("user.get,moderator,admin")]
        ...
        public IDataResult<List<OperationClaim>> GetClaimsDataResult(User user)
        {
            return new SuccessDataResult<List<OperationClaim>>(_userDal.GetClaims(user));
        }

        public IDataResult<User> GetByMailDataResult(string email)
        {
        ...
        public IResult AddResult(User user)
        {
            _userDal.Add(user);
